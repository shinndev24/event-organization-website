export default function FranquiciaOpportunity() {
  const opportunities = [
    ...
    { title: 'Marca de prestigio', description: 'Nuestra inmobiliaria es sinónimo de solidez y éxito en el sector inmobiliario.' },
  ...
  return (
    <section className="franquicia-opportunity">
      ...
      <p className="opportunity-intro">Contarás con el respaldo de una marca reconocida y una red en constante expansión, tendrás todas las herramientas necesarias para el éxito.</p>
